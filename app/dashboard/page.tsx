      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">4 upcoming sessions</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">12 summaries generated</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              {[
                'Physics Group Study - Tomorrow 3 PM',
                'Math Tutoring - Friday 2 PM',
                'History Quiz Prep - Saturday 11 AM',
              ].map((session) => (
                <div
                  key={session}
                  className="flex items-center justify-between rounded-lg border p-3"
